...
if __name__ == '__main__':
    ...
    stream.filter(track=['realDonaldTrump', 'WWE', 'Cristiano', 'BarackObama', 'justinbieber', 'python', 'NBA', 'pitbull', 'BillGates', 'CNN', 'BBCBreaking', 'HillaryClinton', 'LeoDiCaprio', 'Rihanna', 'taylorswift', 'javascript', 'ruby', 'java', 'bigdata', 'hadoop', 'datascience', 'sas'])
